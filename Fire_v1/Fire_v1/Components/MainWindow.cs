...
namespace Fire_v1.Components
{
    public sealed class MainWindow : GameWindow
    {
        ...
        720, // initial height
        new GraphicsMode(new ColorFormat(8, 8, 8, 8), 24),
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            back = new Background();
            int bgtex = Textures.AddTexture(@"Components\GRASS.jpg");
            Textures.Load();
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Matrix4 fire_shadow_projection = Matrix4.CreatePerspectiveFieldOfView((float)(Math.PI / 2.0), 1.0f, 5f, 500f);
            Matrix4 fire_shadow_modelview = Matrix4.CreateRotationY((float)(Math.PI / 2.0f * 3)) * Matrix4.CreateTranslation(0.0f, -10f, 0.0f);
            ...
            Matrix4 pep_transform = Matrix4.CreateScale(0.6f, 0.6f, 0.6f) * Matrix4.CreateTranslation(-10.0f, -0.9f, -25.0f);
            ...
            Matrix4 New = Matrix4.CreateScale(8.0f, 8.0f, 8.0f) * _ViewMatrix;
            ...
            // pep.Render(_projectionMatrix, pep_transform * _ViewMatrix, fire_shadow_modelview * fire_shadow_projection);
            GL.UseProgram(prog);
